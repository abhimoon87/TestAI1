...
PROVIDERS = [
    ...
    (
        ...
        "use_indian_market",
        {
            "_delivery_pct": lambda r: (
                r.get("delivery").delivery_pct if r.get("delivery") else None
            ),
            "_delivery_change_pct": lambda r: (
                r.get("delivery").delivery_change_pct if r.get("delivery") else None
            ),
            "_delivery_source": lambda r: "nse" if r.get("delivery") else None,
            "_fii_is_buying": lambda r: (
                r.get("fii_dii").fii_is_buying if r.get("fii_dii") else None
            ),
            "_dii_is_buying": lambda r: (
                r.get("fii_dii").dii_is_buying if r.get("fii_dii") else None
            ),
            "_fii_net": lambda r: (
                r.get("fii_dii").fii_net if r.get("fii_dii") else None
            ),
            "_dii_net": lambda r: (
                r.get("fii_dii").dii_net if r.get("fii_dii") else None
            ),
            "_institutional_source": lambda r: "nse" if r.get("fii_dii") else None,
            "_52w_position": lambda r: (
                r.get("week52").position_in_range if r.get("week52") else None
            ),
            "_52w_pct_from_high": lambda r: (
                r.get("week52").pct_from_52w_high if r.get("week52") else None
            ),
    ...
    (
        "india_fund",
        fetch_indian_fundamentals,
        "use_indian_fundamentals",
        {
            "_pe_relative_to_industry": lambda r: (
                r.get("screener").stock_pe / r.get("screener").industry_pe
                if r.get("screener")
                and r.get("screener").industry_pe
                and r.get("screener").stock_pe
                else None
            ),
            "_is_quality_stock": lambda r: (
                r.get("screener").is_quality if r.get("screener") else None
            ),
